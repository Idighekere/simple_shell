...
shell_list *__insert_node_at_index(shell_list_t **head, unsigned int idx,
	void *ptr);
...
shell_list_s *get_node_at_index(shell_list_s,
unsigned int index);
shell_list_s *insert_node_at_index(shell_list_s **head, inisigned int idx,
char *ptr);
...
char *_reverse(char *str, in tn);
char *itoa(int num);
char *memset(char *s, char b, int n);
